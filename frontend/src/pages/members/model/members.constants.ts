...
export const MEMBER_DETAILS_TEXT = {
    ...
    removeStudentError: "Не удалось убрать ученика из списка",
    ...
    removeStudent: "Убрать из списка учеников",
    removeStudentConfirmTitle: "Убрать ученика из списка?",
    removeStudentCoachConfirmBody: "Профиль и история останутся. Будет удалена только связь с вашим списком учеников.",
    removeStudentAdminConfirmBody: "Профиль и история останутся. Будет удалена только связь со списком тренера:",
    removeStudentConfirm: "Убрать из списка",
    removeStudentRemoving: "Убираем…",
