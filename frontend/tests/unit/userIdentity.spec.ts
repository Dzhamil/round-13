...
const user: PanelUserListItem = {
    ...
    nickname: "boxer", phone: "+79991234567", roleCode: "ATHLETE", status: "ACTIVE",
};

test("FIO uses trimmed profile parts, then legacy name, never nickname or phone", () => {
    expect(userFullName({ ...user, surname: " Иванов ", firstName: " Иван ", patronymic: " Иванович ", fullName: "Legacy" }))
        .toBe("Иванов Иван Иванович");
    expect(userFullName({ ...user, surname: " Иванов ", fullName: "Legacy" })).toBe("Иванов");
...
test("profile requires each explicit name part even with legacy name and stale completion flag", () => {
    const complete: MeResponse = {
        ...user, role: "ATHLETE", surname: "Иванов", firstName: "Иван", patronymic: "Иванович",
